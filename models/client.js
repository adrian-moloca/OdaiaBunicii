...
const ClientSchema = new Schema({
        ...
        editedPhotos: [{base64: {type: String, default: ''}, label: {type: String, default: ''}, source: {type: Schema.Types.Mixed}, type: {type: String, default: ''}, dim: {type: String, default: ''}, price: {type: String, default: ''}, numberOfItems: {type: Number, default: 1}}],
